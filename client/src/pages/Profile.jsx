...
const Profile = () => {
  return (
    <div className="flex flex-col lg:flex-row mt-6 mr-10 lg:mr-0">
      <div className="flex flex-col w-full lg:w-3/4 mr-20">
        ...
        <div className="border border-gray-400 bg-white h-40 mt-10 ml-5 md:ml-10 lg:ml-20 w-full mr-10 lg:mr-0"></div>
      </div>
